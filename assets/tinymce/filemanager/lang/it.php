...
define ( 'lang_Copy_Cut_Count_Limit', 'Hai selezionato troppi file/cartelle da %s. Il limite è: %d file/operazione' ); // %s = cut or copy
define ( 'lang_Copy_Cut_Not_Allowed', 'Non hai i permessi per %s %s.' ); // %s(1) = cut or copy, %s(2) = files or folders
...
define ( 'lang_Upload_message', 'Trascina qui i file per l\'upload' );
