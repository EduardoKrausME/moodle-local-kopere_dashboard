...
define ( 'lang_Copy_Cut_Size_Limit', 'Les fichiers/dossiers sélectionnés sont trop gros pour %1$s. Limite: %2$d MB/opération' ); // %1$s = cut or copy, %2$d = max size
define ( 'lang_Copy_Cut_Count_Limit', 'Vous avez sélectionné trop de fichiers/dossier pour %1$s. Limite: %2$d fichiers/opération' ); // %1$s = cut or copy, %2$d = max count
define ( 'lang_Copy_Cut_Not_Allowed', 'Vous n\'êtes pas autorisé à %1$s des %2$s.' ); // %12$s = cut or copy, %2$s = files or folders
...
define ( 'lang_Yes', 'Oui' );
define ( 'lang_No', 'Non' );
define ( 'lang_Lang_Not_Found', 'Le fichier de langue est introuvable.' );
...
define ( 'lang_Upload_message', 'Glissez les fichier ici pour les ajouter' );

define ( 'lang_SERVER ERROR', 'ERREUR SERVEUR' );
define ( 'lang_forbiden', 'Interdit' );
define ( 'lang_wrong path', 'Chemin invalide' );
define ( 'lang_wrong name', 'Nom invalide' );
define ( 'lang_wrong extension', 'Extension invalide' );
define ( 'lang_wrong option', 'Option invalide' );
define ( 'lang_wrong data', 'Données invalides' );
define ( 'lang_wrong action', 'Action invalide' );
define ( 'lang_wrong sub-action', 'Sous-action invalide' );
define ( 'lang_no action passed', 'Aucune action demandée' );
define ( 'lang_no path', 'Chemin manquant' );
define ( 'lang_no file', 'Fichier manquant' );
define ( 'lang_view type number missing', 'Type de vue manquant' );
define ( 'lang_Not enought Memory', 'Mémoire insuffisante' );
define ( 'lang_max_size_reached', 'Votre répertoire d\'image a déjà atteind sa taille maximale de %d mo.' ); //%d = max overall size
define ( 'lang_B', 'o' );
define ( 'lang_KB', 'ko' );
define ( 'lang_MB', 'mo' );
define ( 'lang_GB', 'go' );
define ( 'lang_TB', 'to' );
define ( 'lang_total size', 'Taille totale' );
