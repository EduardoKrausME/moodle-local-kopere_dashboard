...
class menu {
    ...
    public static function get_definition(context $context): array {
        return [
            ...
            'items' => [
                [
                    'title' => get_string('menu_title', 'koperedashboard_benchmark'),
                    'description' => get_string('menu_desc', 'koperedashboard_benchmark'),
                    'url' => '/local/kopere_dashboard/plugins/benchmark/index.php',
                    'icon' => 'speed',
                    'capability' => [
