...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function t(n) {
            ...
            function S(e, t) {
                var n, i, o, a, s, l;
                for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = $(e), ++i, a = M[q] - i, o = e.nextSibling; o && a > 0;)s = o.nextSibling, l = D(o, t), n && n.appendChild(l), --a, o = s;
                return t != O && (M.setStartAfter(e), M.collapse(F)), n
            }

            function T(e, t, n) {
                var i, o, a, s, l, c, d;
                for (n != I && (o = r()), i = A(e, n), o && o.appendChild(i), a = $(e), s = $(t), ++a, l = s - a, c = e.nextSibling; l > 0;)d = c.nextSibling, i = D(c, n), o && o.appendChild(i), c = d, --l;
                    ...
                    if (c < l.index && s.text(F(e.substr(c, l.index - c))), d = l[6])d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), r(d); else if (d = l[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), x = d in b, z && L[d] && f.length > 0 && f[f.length - 1].name === d && r(d), !w || (_ = o.getElementRule(d))) {
                            if (E = !0, w && (S = _.attributes, T = _.attributePatterns), (k = l[8]) ? (v = -1 !== k.indexOf("data-mce-type"), v && y && (E = !1), p = [], p.map = {}, k.replace(H, a)) : (p = [], p.map = {}), w && !v) {
                                if (R = _.attributesRequired, A = _.attributesDefault, B = _.attributesForced, D = _.removeEmptyAttrs, D && !p.length && (E = !1), B)for (m = B.length; m--;)N = B[m], g = N.name, O = N.value, "{$uid}" === O && (O = "mce_" + I++), p.map[g] = O, p.push({name: g, value: O});
                                if (A)for (m = A.length; m--;)N = A[m], g = N.name, g in p.map || (O = N.value, "{$uid}" === O && (O = "mce_" + I++), p.map[g] = O, p.push({name: g, value: O}));
                                if (R) {
                ...
                function i(e, t, i) {
                    ...
                    if (s)if (s.length === Q) {
                        for (o in s)if (s.hasOwnProperty(o)) {
                            if (a = "attributes" === i ? z.getAttrib(e, o) : N(e, o), r && !a && !t.exact)return;
                            if ((!r || t.exact) && !E(a, k(S(s[o], n), o)))return
                        }
                    } else for (l = 0; l < s.length; l++)if ("attributes" === i ? z.getAttrib(e, s[l]) : N(e, s[l]))return t;
                    return t
                }
            ...
            function A(t, n, r) {
                ...
                function f(e, t) {
                    ...
                    if (n[0].wrapper || (r = z.getParent(e, n[0].block, i)), r || (r = z.getParent(3 == e.nodeType ? e.parentNode : e, function (e) {
                        return e != i && o(e)
                    })), r && n[0].wrapper && (r = a(r, "ul,ol").reverse()[0] || r), !r)for (r = e; r[t] && !q(r[t]) && (r = r[t], !E(r, "br")););
                    return r || e
                }
        ...
        function a(e) {
            ...
            f = i(), s({bold: "Bold", italic: "Italic", underline: "Underline", strikethrough: "Strikethrough", subscript: "Subscript", superscript: "Superscript"}, function (t, n) {
                ...
                var n = [], i = r(e.settings.block_formats || "Paragraph=p;Address=address;Blockquote=blockquote;Pre=pre;Heading 1=h1;Heading 2=h2;Heading 3=h3;Heading 4=h4;Heading 5=h5;Heading 6=h6");
        ...
        return e.extend({recalc: function (e) {
            ...
            if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                ...
                if (D)for (u = 0; u < D.length; u++)B += D[u]; else B = r;
                var L = T / B;
