...
$string['friendly_installation_alternative_not_desc'] = 'Nainštalujte a nakonfigurujte <a href="https://moodle.org/plugins/local_alternative_file_system" target="_blank">Alternative File System</a>, aby sa optimalizoval čas migrácie, súbory Moodle boli vo vzdialenom úložisku, znížil sa tlak na lokálny disk, zjednodušili sa klastrové prostredia, zlepšila odolnosť a podľa potreby sa využilo doručovanie cez CDN. Bez neho tento export zahrnie lokálne súbory moodledata do vygenerovaného ZIP balíka.';
$string['friendly_installation_alternative_not_title'] = 'Alternative File System nie je nainštalovaný alebo nakonfigurovaný';
$string['friendly_installation_alternative_ok_desc'] = 'Skontrolujte v <a href="{$a}" target="_blank">alternatívnom súborovom systéme</a>, či sú všetky súbory vo vzdialenom úložisku pred spustením obnovy.';
$string['friendly_installation_alternative_ok_title'] = 'Alternative File System nainštalovaný';
$string['friendly_installation_desc'] = 'Exportuje databázu vo formáte kompatibilnom s <a href="https://github.com/EduardoKrausME/moodle_friendly_installation" target="_blank">inštalátorom softvéru Moodle™</a> a MoodleData.';
$string['friendly_installation_generate'] = 'Exportovať';
$string['friendly_installation_success'] = 'Export bol úspešne vygenerovaný!';
$string['friendly_installation_title'] = 'Export pre inštalátor softvéru Moodle™';
...
$string['type_friendly_installation'] = 'Inštalátor softvéru Moodle™';
