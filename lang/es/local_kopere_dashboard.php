...
$string['courses_student_ok'] = 'Usuario creado exitosamente:<br><strong>Ingreso:</strong> {$a->login}<br><strong>Contraseña:</strong> {$a->password}';
...
$string['notification_testsmtp_subject'] = 'Kopere Dashboard - Prueba de envío de correo electrónico - ';
...
$string['userimport_date_desc'] = 'El sistema detecta automaticamente el formato principal de fecha.';
...
$string['vvveb_home_automatically_my_course'] = 'No editar. Este bloque será reemplazado automaticamente con los cursos en los que el estudiante está inscrito.';
...
$string['webpages_access'] = 'Ir a la página';
