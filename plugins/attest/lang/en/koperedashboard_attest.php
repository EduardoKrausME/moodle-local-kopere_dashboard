...
$string['all_issues_button'] = 'View all attestations';
$string['all_issues_desc'] = '{$a} attestation(s) found.';
$string['all_issues_title'] = 'All attestations';
...
$string['empty_all_issues'] = 'No attestations were found with the selected filters.';
...
$string['student_removed'] = 'Removed student (#{$a})';
