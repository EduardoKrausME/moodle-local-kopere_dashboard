...
$string['kopere_dashboard:managepermissions'] = 'Manage Kopere Dashboard permissions';
$string['kopere_dashboard:view'] = 'View Kopere Dashboard';
$string['kopere_dashboard:viewaudit'] = 'View Kopere Dashboard audit log';
...
$string['notification_manager'] = 'Notification preferences';
$string['order'] = 'Order';
...
$string['student_courses_title_desc'] = 'Open the full list of your courses.';
