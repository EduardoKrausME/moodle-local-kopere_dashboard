define(["jquery", "local_kopere_dashboard/dataTables", "local_kopere_dashboard/dataTables.sorting-currency", "local_kopere_dashboard/dataTables.sorting-date-uk", "local_kopere_dashboard/dataTables.sorting-file-size", "local_kopere_dashboard/dataTables.sorting-numeric-comma"], function($, datatables) {
    return {
        init     : function(selector, params) {
            ...
            var renderer = {
                dataVisibleRenderer      : function(data, type, row) {
                    ...
                    if (data < 1e3 * 1e3 * 1e3 * 1e3) {
                        data = data / (1e3 * 1e3 * 1e3);
                        return data.toFixed(2) + " Gb"
                    }
                    if (data < 1e3 * 1e3 * 1e3 * 1e3 * 1e3) {
                        data = data / (1e3 * 1e3 * 1e3 * 1e3);
