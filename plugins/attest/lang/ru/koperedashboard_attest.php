...
$string['all_issues_button'] = 'Просмотреть все справки';
$string['all_issues_desc'] = 'Найдено справок: {$a}.';
$string['all_issues_title'] = 'Все справки';
...
$string['empty_all_issues'] = 'По выбранным фильтрам справки не найдены.';
...
$string['filter_all_students'] = 'Все студенты';
$string['filter_apply'] = 'Фильтровать';
$string['filter_clear'] = 'Очистить';
...
$string['student_removed'] = 'Удалённый студент (#{$a})';
