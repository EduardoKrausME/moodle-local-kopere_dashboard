...
define ( 'lang_Upload_message', 'Перетащите файл сюда, чтобы загрузить' );
define ( 'lang_SERVER ERROR', 'СЕРВЕРНАЯ ОШИБКА' );
define ( 'lang_forbiden', 'Запрещено' );
define ( 'lang_wrong path', 'Неверный путь' );
define ( 'lang_wrong name', 'Неверное имя' );
define ( 'lang_wrong extension', 'Неверное расширение' );
define ( 'lang_wrong option', 'Неверная опция' );
define ( 'lang_wrong data', 'Неверные данные' );
define ( 'lang_wrong action', 'Неверное действие' );
define ( 'lang_wrong sub-action', 'Неверное доп.действие' );
define ( 'lang_no action passed', 'Действие не сработало' );
define ( 'lang_no path', 'Путь не существует' );
define ( 'lang_no file', 'Файл не существует' );
define ( 'lang_view type number missing', 'Данный тип отсутствует' );
define ( 'lang_Not enought Memory', 'Недостаточно памяти' );
define ( 'lang_max_size_reached', 'Папка достигла максимального размера в %d MB.' ); //%d = max overall size
define ( 'lang_B', 'B' );
define ( 'lang_KB', 'KB' );
define ( 'lang_MB', 'MB' );
define ( 'lang_GB', 'GB' );
define ( 'lang_TB', 'TB' );
define ( 'lang_total size', 'Общий размер' );
