...
$string['dashboard_enrol_text'] = 'Usted se ha inscrito en el curso <a href="?courses::details&courseid={$a->courseid}">{$a->fullname}</a> y';
$string['dashboard_enrol_title'] = 'Última inscripción';
$string['dashboard_grade_in'] = 'En';
$string['dashboard_grade_incourse'] = 'en curso <a href="?courses::details&courseid={$a->courseid}">{$a->coursename}</a>';
$string['dashboard_grade_inmod'] = 'en módulo <a href="?courses::details&courseid={$a->courseid}">{$a->coursename}</a>';
...
$string['notification_local_kopere_dashboard_hotmoodle'] = 'HotMoodle Kopere';
$string['notification_local_kopere_dashboard_moocommerce'] = 'MooCommerce Kopere';
