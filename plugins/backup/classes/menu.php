...
class menu {
    ...
    public static function get_definition(context $context): array {
        return [
            ...
            "items" => [
                [
                    "title" => get_string("menu_title", "koperedashboard_backup"),
                    "description" => get_string("menu_desc", "koperedashboard_backup"),
                    "url" => "/local/kopere_dashboard/plugins/backup/",
                    "icon" => "backup",
                    "capability" => "koperedashboard/backup:manage",
                ],
            ],
        ];
    }
