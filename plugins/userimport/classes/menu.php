...
class menu {
    ...
    public static function get_definition(context $context): array {
        return [
            ...
            "items" => [
                [
                    "title" => get_string("menu_title", "koperedashboard_userimport"),
                    "description" => get_string("menu_desc", "koperedashboard_userimport"),
                    "url" => [
                        "/local/kopere_dashboard/plugins/userimport/manage.php",
                    ],
                    "icon" => "person_add",
                    "capability" => [
