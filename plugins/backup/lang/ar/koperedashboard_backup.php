...
$string['friendly_installation_alternative_not_desc'] = 'ثبّت واضبط <a href="https://moodle.org/plugins/local_alternative_file_system" target="_blank">Alternative File System</a> لتحسين وقت الترحيل، والاحتفاظ بملفات Moodle في تخزين بعيد، وتقليل الضغط على القرص المحلي، وتسهيل بيئات العناقيد، وتحسين المرونة، واستخدام CDN عند الحاجة. بدونه، سيتضمن هذا التصدير ملفات moodledata المحلية داخل ملف ZIP الذي يتم إنشاؤه.';
$string['friendly_installation_alternative_not_title'] = 'Alternative File System غير مثبت أو غير مكوّن';
$string['friendly_installation_alternative_ok_desc'] = 'تحقق في <a href="{$a}" target="_blank">نظام الملفات البديل</a> من أن جميع الملفات موجودة في التخزين البعيد قبل تنفيذ الاستعادة.';
$string['friendly_installation_alternative_ok_title'] = 'تم تثبيت Alternative File System';
$string['friendly_installation_desc'] = 'يصدّر قاعدة البيانات بتنسيق متوافق مع <a href="https://github.com/EduardoKrausME/moodle_friendly_installation" target="_blank">مثبّت برنامج Moodle™</a> و MoodleData.';
$string['friendly_installation_generate'] = 'تصدير';
$string['friendly_installation_success'] = 'تم إنشاء التصدير بنجاح!';
$string['friendly_installation_title'] = 'تصدير إلى مثبّت برنامج Moodle™';
...
$string['type_friendly_installation'] = 'مثبّت برنامج Moodle™';
