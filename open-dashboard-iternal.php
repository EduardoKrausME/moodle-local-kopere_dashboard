...
$PAGE->set_url(new moodle_url('/local/kopere_dashboard/open-dashboard-iternal.php'));
...
$PAGE->navbar->add(get_string_kopere('modulename'), new moodle_url('local/kopere_dashboard/open-dashboard-iternal.php'));
