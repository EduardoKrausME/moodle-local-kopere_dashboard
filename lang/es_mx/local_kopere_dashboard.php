...
$string['datatables_sInfoFiltered'] = '(Filtrados de _MAX_ records)';
...
$string['backup_deletesucessfull'] = '¡Resplado eliminado exitosamente!';
...
$string['courses_titleenrol'] = 'Estudiantes inscritosd';
...
$string['notification_testsmtp_message'] = '<p> Esta es una prueba de envío de correo electrónico. </p>';
$string['notification_testsmtp_error'] = '¡Moodle no envía correos electrónicos cuando el destinatario y el remitente son iguales! <br> Y usted es el administrador principal de este moodle. Por lo tanto, para probar debe iniciar sesión con otro administrador.';
$string['notification_testsmtp_subject'] = 'Prueba de envío de correo electrónico - ';
...
$string['userimport_empty'] = 'Si Usted no lo selecciona, se usará el valor predeterminado de "{$a}"';
...
<p>Acceda a {{course.link}}, y estudie.</p>
<p>Si tiene dudas, con gusto se las resolveremos.</p>
<p>Atentamente,<br>
...
$string['webpages_page_analyticsdesc'] = 'Secuancia de 13 caracteres, comenzando en UA';
$string['webpages_theme_base'] = 'El diseño sin los bloques';
$string['webpages_theme_standard'] = 'Diseño redeterminado con bloques';
...
$string['notification_local_kopere_dashboard'] = 'Kopere Tablero';
...
$string['notification_local_kopere_pay'] = 'Kopere Pago';
