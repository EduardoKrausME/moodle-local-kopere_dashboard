...
$string['courses_enrol_new_form'] = 'Usuário não encontrado, Então vamos cadastrar primeiro';
...
$string['userimport_date_desc'] = 'O sistema detecta automaticamente os principais formato de data.';
...
$string['webpages_access'] = 'Ir para a página';
