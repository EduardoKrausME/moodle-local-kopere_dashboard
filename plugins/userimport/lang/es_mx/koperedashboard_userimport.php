...
$string['cap_manage'] = 'Administrar importaciones de usuarios';
...
$string['invalidtoken'] = 'El token de importación no es válido o expiró.';
$string['invalidusername'] = 'Valor de nombre de usuario no válido.';
$string['manage_intro'] = 'Sube un archivo CSV para crear usuarios, reutilizar cuentas existentes, llenar campos personalizados del perfil y, opcionalmente, inscribirlos en cursos y grupos.';
$string['manualinstance_missing'] = 'El curso {$a} no tiene una instancia de inscripción manual habilitada.';
$string['manualplugin_missing'] = 'El plugin de inscripción manual no está disponible en este sitio Moodle.';
...
$string['menu_desc'] = 'Importa usuarios mediante CSV, previsualiza el resultado, crea cuentas y, opcionalmente, inscríbelos en cursos/grupos.';
...
$string['result_alreadyenrolled'] = 'Ya inscrito';
$string['result_courseenrolled'] = 'Inscrito en {$a}';
$string['result_groupadded'] = 'Agregado al grupo {$a}';
...
$string['summary_enrolled'] = 'Nuevas inscripciones';
...
$string['tip_existing'] = 'Los usuarios existentes no se duplican. Aún pueden recibir datos de campos personalizados e inscripciones a cursos.';
