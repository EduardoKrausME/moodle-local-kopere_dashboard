    ...
    function showDialog(imageList) {
        ...
        if (imgElm.nodeName == 'IMG' && !imgElm.getAttribute('data-mce-object') && !imgElm.getAttribute('data-mce-placeholder')) {
            data = {
                ...
                classe: dom.getAttrib(imgElm, 'class'),
                width: width,
                height: height
            };
        } else {
        ...
        if (imageDimensions) {
            ...
            generalFormItems.push({name: 'classe', type: 'textbox', label: 'Classe CSS'});
        }

        generalFormItems.push(classListCtrl);

        function buildListItems2(inputList, itemCallback, startItems) {
            function appendItems(values, output) {
                output = output || [];
