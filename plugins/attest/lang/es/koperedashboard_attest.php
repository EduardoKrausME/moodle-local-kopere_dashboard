...
$string['studentcard_back_placeholder_sitefullname'] = 'Nombre completo formateado del sitio Moodle.';
...
$string['studentcard_back_placeholder_validationcode'] = 'Código público de validación generado para el carné de estudiante.';
$string['studentcard_back_placeholder_verifyurl'] = 'URL pública utilizada para validar el carné de estudiante.';
$string['studentcard_back_placeholder_wwwroot'] = 'URL base del sitio Moodle.';
$string['studentcard_desc'] = '';
$string['studentcard_front_placeholder_coursefullname'] = 'Nombre completo formateado del primer curso visible en el que está matriculado el estudiante.';
$string['studentcard_front_placeholder_courselabel'] = 'Etiqueta traducida del curso.';
$string['studentcard_front_placeholder_cpf'] = 'CPF obtenido del campo personalizado del perfil, utilizando el número de identificación como alternativa.';
$string['studentcard_front_placeholder_cpflabel'] = 'Etiqueta del campo CPF.';
$string['studentcard_front_placeholder_email'] = 'Dirección de correo electrónico del estudiante.';
$string['studentcard_front_placeholder_fullname'] = 'Nombre completo del estudiante.';
$string['studentcard_front_placeholder_photo'] = 'Foto del perfil como URI de datos de imagen Base64 incrustada.';
$string['studentcard_front_placeholder_title'] = 'Título traducido del carné de estudiante.';
...
$string['studentcard_settings_back_template_help'] = 'Mustache y HTML procesados por TCPDF en la página 2 del carné de estudiante. Mantenga la URL de validación o el código QR en el diseño para que el documento siga siendo verificable.';
$string['studentcard_settings_back_variables'] = 'Variables disponibles en el reverso';
$string['studentcard_settings_back_variables_desc'] = 'Estas variables Mustache se sustituyen al generar el lado de validación del PDF.';
$string['studentcard_settings_description'] = 'Edite las dos plantillas Mustache/HTML utilizadas para generar el PDF del carné de estudiante. El anverso contiene la identidad del estudiante y el curso; el reverso contiene el código, el enlace público y el código QR de validación.';
$string['studentcard_settings_front'] = 'Plantilla del anverso';
$string['studentcard_settings_front_template'] = 'Mustache del anverso';
$string['studentcard_settings_front_template_help'] = 'Mustache y HTML procesados por TCPDF en la página 1 del carné de estudiante. La imagen debe mantenerse mediante la variable de foto, proporcionada como una URI de datos incrustada.';
$string['studentcard_settings_front_variables'] = 'Variables disponibles en el anverso';
$string['studentcard_settings_front_variables_desc'] = 'Estas variables Mustache se sustituyen al generar el lado de identificación del PDF.';
$string['studentcard_settings_menu'] = 'Plantilla del carné de estudiante';
$string['studentcard_settings_title'] = 'Plantilla del carné de estudiante';
