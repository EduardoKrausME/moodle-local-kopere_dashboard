...
$base_url = $CFG->wwwroot . '/local/kopere_dashboard/attach.php?src=';  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = 'upload/' . $subFolder; // path from base_url to base of upload folder (with start and final /)
$current_path = $CFG->dataroot . '/kopere/dashboard/upload/' . $subFolder; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $CFG->dataroot . '/kopere/dashboard/upload_thumb/' . $subFolder; // relative path from filemanager folder to thumbs folder (with final /)
...
$ext = array_merge($ext_img, $ext_file, $ext_misc); //allowed extensions
...
$fixed_path_from_filemanager = array('../test/',
    '../test1/'
