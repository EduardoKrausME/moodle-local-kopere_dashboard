...
$string['all_issues_title'] = 'すべての証明書';
...
$string['back_to_templates'] = 'テンプレートに戻る';
...
$string['empty_all_issues'] = '選択したフィルタに一致する証明書はありません。';
...
$string['filter_all_courses'] = 'すべてのコース';
$string['filter_all_students'] = 'すべての学生';
$string['filter_apply'] = '絞り込む';
$string['filter_clear'] = 'クリア';
$string['filter_course'] = 'コース';
$string['filter_student'] = '学生';
...
$string['student_removed'] = '削除された学生 (#{$a})';
