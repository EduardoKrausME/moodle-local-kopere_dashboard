...
define ( 'lang_File_Permission', 'Permisos de archivos' );
define ( 'lang_File_Permission_Not_Allowed', 'Cambiar %s permisos no está permitido.' ); // %s = files or folders
define ( 'lang_File_Permission_Recursive', 'Aplicar recursivamente?' );
define ( 'lang_File_Permission_Wrong_Mode', 'El modo de permiso suministrado es incorrecto.' );
define ( 'lang_User', 'Usuario' );
define ( 'lang_Group', 'Grupo' );
define ( 'lang_Yes', 'Si' );
define ( 'lang_No', 'No' );
define ( 'lang_Lang_Not_Found', 'Could not find language.' );
define ( 'lang_Lang_Change', 'Cambiar idioma' );
define ( 'lang_File_Not_Found', 'No se puede encontrar el archivo.' );
define ( 'lang_File_Open_Edit_Not_Allowed', 'No estás autorizado a %s este archivo.' ); // %s = open or edit
define ( 'lang_Edit', 'Editar' );
define ( 'lang_Edit_File', 'Editar contenido del archivo' );
define ( 'lang_File_Save_OK', 'Archivo guardado satisfactoriamente.' );
define ( 'lang_File_Save_Error', 'Ocurrió un error guardando el archivo.' );
define ( 'lang_New_File', 'Nuevo archivo' );
define ( 'lang_No_Extension', 'Debes añadir una extensión al archivo.' );
define ( 'lang_Valid_Extensions', 'Extensiones válidas: %s' ); // %s = txt,log etc.
define ( 'lang_Upload_message', 'Arrastra archivos aquí para subir' );
define ( 'lang_SERVER ERROR', 'ERROR DEL SERVIDOR' );
define ( 'lang_forbiden', 'Prohibido' );
define ( 'lang_wrong path', 'Ruta incorrecta' );
define ( 'lang_wrong name', 'Nombre incorrecto' );
define ( 'lang_wrong extension', 'Extensión incorrecta' );
define ( 'lang_wrong option', 'Opción incorrecta' );
define ( 'lang_wrong data', 'Datos incorrectos' );
define ( 'lang_wrong action', 'Acción incorrecta' );
define ( 'lang_wrong sub-action', 'Sub-acción incorrecta' );
define ( 'lang_no action passed', 'No se ha recibido una acción' );
define ( 'lang_no path', 'Sin ruta' );
define ( 'lang_no file', 'Sin archivo' );
define ( 'lang_view type number missing', 'Falta el número de tipo de vista' );
define ( 'lang_Not enought Memory', 'No hay memória suficiente' );
define ( 'lang_max_size_reached', 'La carpeta de imágenes ha excedido el tamaño máximo de %d MB.' ); //%d = max overall size
define ( 'lang_B', 'B' );
define ( 'lang_KB', 'KB' );
define ( 'lang_MB', 'MB' );
define ( 'lang_GB', 'GB' );
define ( 'lang_TB', 'TB' );
define ( 'lang_total size', 'Tamaño total' );
