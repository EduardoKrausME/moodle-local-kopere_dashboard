...
$string['delete_cancel'] = 'キャンセル';
$string['delete_confirm_button'] = 'はい、ファイルを削除します';
$string['delete_confirm_message'] = 'この生成済みバックアップファイルを削除してもよろしいですか？この操作は元に戻せません。';
$string['delete_confirm_title'] = 'バックアップファイルを削除';
$string['delete_success'] = 'バックアップファイルを削除しました: {$a}';
$string['deletefailed'] = 'バックアップファイルを削除できませんでした: {$a}';
...
$string['friendly_installation_alternative_not_desc'] = '<a href="https://moodle.org/plugins/local_alternative_file_system" target="_blank">Alternative File System</a> をインストールして設定すると、移行時間を最適化し、Moodle のファイルをリモートストレージに保持し、ローカルディスクの負荷を下げ、クラスター環境を扱いやすくし、耐障害性を高め、必要に応じて CDN 配信も利用できます。未設定の場合、このエクスポートはローカルの moodledata ファイルを生成 ZIP に含めます。';
$string['friendly_installation_alternative_not_title'] = 'Alternative File System がインストールまたは設定されていません';
$string['friendly_installation_alternative_ok_desc'] = '<a href="{$a}" target="_blank">代替ファイルシステム</a> で、復元を実行する前にすべてのファイルがリモートストレージにあることを確認してください。';
$string['friendly_installation_alternative_ok_title'] = 'Alternative File System がインストールされています';
$string['friendly_installation_desc'] = 'データベースを <a href="https://github.com/EduardoKrausME/moodle_friendly_installation" target="_blank">Moodle™ソフトウェアインストーラー</a> および MoodleData と互換性のある形式でエクスポートします。';
$string['friendly_installation_generate'] = 'エクスポート';
$string['friendly_installation_success'] = 'エクスポートが正常に生成されました!';
$string['friendly_installation_title'] = 'Moodle™ソフトウェアインストーラーへのエクスポート';
...
$string['type_friendly_installation'] = 'Moodle™ ソフトウェアインストーラー';
