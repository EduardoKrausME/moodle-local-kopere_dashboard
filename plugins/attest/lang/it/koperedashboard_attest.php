...
$string['all_issues_title'] = 'Tutte le attestazioni';
...
$string['back_to_templates'] = 'Torna ai modelli';
...
$string['empty_all_issues'] = 'Nessuna attestazione trovata con i filtri selezionati.';
...
$string['filter_all_courses'] = 'Tutti i corsi';
$string['filter_all_students'] = 'Tutti gli studenti';
$string['filter_apply'] = 'Filtra';
$string['filter_clear'] = 'Cancella';
$string['filter_course'] = 'Corso';
$string['filter_student'] = 'Studente';
...
$string['student_removed'] = 'Studente rimosso (#{$a})';
