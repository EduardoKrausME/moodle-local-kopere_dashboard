tinymce.PluginManager.add("autosave", function (e) {
    ...
    function f() {
        ...
        return tinymce.each(tinymce.editors, function (t) {
            t.plugins.autosave && t.plugins.autosave.storeDraft(), !e && t.isDirty() && t.getParam("autosave_ask_before_unload", !0) && (e = t.translate("Você tem alterações não salvas. Tem certeza de que deseja sair?"))
        }), e
    }
