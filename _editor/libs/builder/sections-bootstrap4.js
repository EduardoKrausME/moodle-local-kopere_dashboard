        ...
        <div class="row text-center text-lg-left">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/ff5c5c/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/5c6dff/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/ffc75c/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/5cffa3/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/ffa15c/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/5c85ff/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/d15cff/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/5cff6f/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/ff5c9d/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/5cffe3/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/ff8e5c/fff" alt="" width="100%">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/400x300/5c5cff/fff" alt="" width="100%">
                </a>
            </div>
        </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active"
                 style="background-image: url('https://dummyimage.com/1920x1080/c5d647/fff')">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow">
                    <img src="https://raw.githubusercontent.com/givanz/landing/3096991d336d9eac9171c06acfc43f8537c7b171/img/sections/team/1.jpg"
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow">
                    <img src="https://raw.githubusercontent.com/givanz/landing/3096991d336d9eac9171c06acfc43f8537c7b171/img/sections/team/2.jpg"
                         class="card-img-top" alt="...">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-0">Team Member</h5>
                        <div class="card-text text-black-50">Web Developer</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow">
                    <img src="https://raw.githubusercontent.com/givanz/landing/3096991d336d9eac9171c06acfc43f8537c7b171/img/sections/team/3.jpg"
                         class="card-img-top" alt="...">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-0">Team Member</h5>
                        <div class="card-text text-black-50">Web Developer</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow">
                    <img src="https://raw.githubusercontent.com/givanz/landing/3096991d336d9eac9171c06acfc43f8537c7b171/img/sections/team/4.jpg"
                         class="card-img-top" alt="...">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-0">Team Member</h5>
                        <div class="card-text text-black-50">Web Developer</div>
        ...
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="https://dummyimage.com/700x400/CCCCCC/9C9C9C" alt=""
                                     width="100%"></a>
                    <div class="card-body">
                        <h4 class="card-title">
