...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
    ...
    ## --------------------------------------------------------
    public function greyScaleDramatic() # Alias of gd_filter_monopin
    {
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
  ...
  Vintage
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
    public function vintage() # Alias of gd_filter_monopin
    {
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
  ...
  Write IPTC Data
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
    public function writeIPTCcaption($value) # Caption
    {
...
## --------------------------------------------------------
    public function setTransparency($bool) # Sep 2011
    {
...
## --------------------------------------------------------
    public function setCropFromTop($value) # Sep 2011
    {
...
## --------------------------------------------------------
    private function checkInterlaceImage($isEnabled) # jpg will use progressive (they don't use interace)
    {
        if ($isEnabled) {
...
## --------------------------------------------------------
    ...
    ## --------------------------------------------------------
    function hex2dec($hex) # Purpose:  Convert #hex color to RGB
    {
    ...
    ## --------------------------------------------------------
    function checkStringStartsWith($needle, $haystack) # Check if a string starts with a specific pattern
    {
